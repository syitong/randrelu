...
do
    ...
    python result_alloc.py --action screen --file eldan-smooth-RF-params
    wait
done
...
do
    ...
    python result_alloc.py --action screen --file eldan-smooth-NN-params
    wait
done
...
do
    ...
    python result_alloc.py --action test --file eldan-smooth-RF-params
    wait
done
...
do
    ...
    python result_alloc.py --action test --file eldan-smooth-NN-params 
    wait
done
